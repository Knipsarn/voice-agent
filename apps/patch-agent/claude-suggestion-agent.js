...
## Platform context
- AI receptionists answer phone calls for Swedish businesses
...
- Prompts are in Swedish (sv-SE) — keep them that way
- Voice matters: prompts must sound natural spoken aloud, not like written text
- The AI uses OpenAI Realtime API (gpt-realtime-1.5) — short, clear instructions work best
...
- Keep Swedish language throughout
